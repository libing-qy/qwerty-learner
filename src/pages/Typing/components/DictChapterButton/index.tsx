...
export const DictChapterButton = () => {
  ...
  const currentChapterTitle = getChapterTitle(currentDictInfo.chapterTitles, currentChapter, 'zh')
                  ...
                  <Listbox.Option key={index} value={index}>
                    {({ selected }) => (
                      <div className="group flex cursor-pointer items-center justify-between">
                        ...
                        <span>{getChapterTitle(currentDictInfo.chapterTitles, index, 'zh')}</span>
                      </div>
                    )}
                  </Listbox.Option>
                ))}
